...
class Logger
  # Make the constructor private using private_class_method
  private_class_method :new 
  
  # Сreate a class variable @@instance
  @@instance = nil 
  
  # Implement self.instance method that returns the single instance
  def self.instance
    @@instance ||= new
  end
